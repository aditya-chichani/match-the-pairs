...
public class Medium extends JFrame implements ActionListener {
    ...
    private static int Hit=0, Miss = 15;
    ...
    public Medium()
    {
        createGUI();
        createJPanels();
        window.setTitle("Match the Pairs - MEDIUM");
    ...
    public void createGUI()
    {
        ...
        exitBtn.addMouseListener(new MouseListener() {
        	...
        	public void mouseExited(MouseEvent e) {
        		exitBtn.setBackground(Color.decode("#5CE68A"));
        	}
        ...
        easyBtn.addMouseListener(new MouseListener() {
			...
			public void mouseExited(MouseEvent e) {
				...
				easyBtn.setBackground(Color.decode("#5CE68A"));
			}
        ...
        mediumBtn.addMouseListener(new MouseListener() {
			...
			@Override
			public void mouseExited(MouseEvent e) {
				mediumBtn.setBackground(Color.decode("#5CE68A"));
			}
        ...
        diffBtn.addMouseListener(new MouseListener() {
			...
			@Override
			public void mouseExited(MouseEvent e) {
				diffBtn.setBackground(Color.decode("#5CE68A"));
			}
        ...
        ruleBtn.addMouseListener(new MouseListener() {
			...
			@Override
			public void mouseExited(MouseEvent e) {
				ruleBtn.setBackground(Color.decode("#5CE68A"));
			}
    ...
    public void createJPanels()
    {
        ...
        P2.add(ruleBtn);
        P2.add(exitBtn);
        P1.setBackground(Color.decode("#5CE68A"));
        P3.setBackground(Color.black);
        P2.setBackground(Color.decode("#5CE68A"));
...
class Boardmedium extends JPanel{
    ...
    public Boardmedium(){
        ...
        for (int val : cardVals){
        	...
        	c.setForeground(Color.decode("#FFFF19"));
        	c.setBackground(Color.decode("#195E31"));
            ...
            c.addMouseListener(new MouseListener() {
				...
				@Override
				public void mouseEntered(MouseEvent e) {
					c.setBackground(Color.decode("#75FF75"));
				}
    ...
    public void checkCards(){
        if (c1.getId() == c2.getId()){//match condition
            ...
            int x=Medium.getHit();
            Medium.setHit(x+1);
            if (this.isGameWon() && Medium.getMiss()!=0){
           ...
           c1.setText(""); //'hides' text
            c2.setText("");
            int x=Medium.getMiss();
            Medium.setMiss(x-1);
        }
        Medium.updateHitMiss();
        if(Medium.getMiss()==0){
        	JOptionPane.showMessageDialog(this, "Oh No!! GAME OVER!! :-(");
            System.exit(0);
        }
